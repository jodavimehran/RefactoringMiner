...
public class OperationBody {
    ...
    public List<VariableDeclaration> getAllVariableDeclarations() {
        ArrayList<VariableDeclaration> allVariableDeclarations = new ArrayList<>(compositeStatement.getAllVariableDeclarations());
        Collections.sort(allVariableDeclarations, (var1, var2) -> Comparator.comparing(VariableScope::getStartOffset).thenComparing(VariableScope::getEndOffset).compare(var1.getScope(), var2.getScope()));
